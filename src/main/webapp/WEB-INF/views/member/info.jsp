...
<div id="alert1" class="alert alert-primary" role="alert">회원정보를 수정하였습니다.</div>
</c:if>
<c:if test="${param.status == 'error' }">
<div id="alert2" class="alert alert-danger" role="alert">회원정보를 수정하지 못했습니다.</div>
</c:if>
		...
		<div class="col-12">
			<form id="member-info-form1" method="post" action="${appRoot }/member/modify">
				<div class="form-group">
					...
					<input readonly value="${member.userid }" id="member-info-input1" type="text" class="form-control" name="userid">
				</div>
				<div class="form-group">
					<label for="member-info-input2">새 패스워드</label>
					
					<div class="input-group">
						<input id="member-info-input2" type="password" class="form-control" name="userpw">
				...
				<div class="form-group">
					...
					<input id="member-info-input4" type="password" class="form-control">
					<small id="member-info-password-message" class="form-text text-danger"></small>
				</div>
				<div class="form-group">
					<label for="member-info-input3">이름</label>
					<input value="${member.userName }" id="member-info-input3" type="text" class="form-control" name="userName">
				</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-danger" id="old-password-modal-btn">확인</button>
			</div>
		</div>
	</div>
