	      ...
	      <form>
	         ...
	         <div class="form-group">
	            <label for="input2">작성자</label>
	         	<input hidden name="writer" class="form-control" id="input2" value="${board.writer }" readonly="readonly">
	         	<input class="form-control"  value="${board.writerName }" readonly="readonly">
	         </div>
      ...
      <div class="modal-body">
        <form>
          ...
          <div class="form-group">
            ...
            <input hidden type="text" value="${pinfo.member.userid }" class="form-control" id="reply-replyer-input1">
          </div>
          <div class="form-group">
      ...
      <div class="modal-body">
        <form>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="reply-replyer-input2" hidden readonly>
          </div>
          <div class="form-group">
            <label for="message-text" class="col-form-label">댓글</label>
